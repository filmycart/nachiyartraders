    <div style="border:0px solid red;width:1200px;float:left;margin:0px;">
    @foreach (\App\Models\Category::where('level', 0)->orderBy('order_level', 'desc')->get()->take(8) as $key => $category)
        <div style="border:0px solid red;width:150px;float:left;" class="categorymenudropdown">
         <a href="{{ route('products.category', $category->slug) }}">
            <div style="border:0px solid red;width:110px;float:left;text-align:center;">
                 <img
