...
<div class=" col-lg-12" id="section_last_viewed_products">
    ...
    @if (count($lastViewedProducts) > 0)
        <section class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="text-center text-sm-left mt-4">
                    ...
                    @if (get_setting('vendor_system_activation') == 1)
                        <h4 class="fs-14 text-secondary text-uppercase fw-700 mb-3">{{ translate('About') }}</h4>
                        <ul class="list-unstyled">
                            <li class="mb-2">
                                <a class="fs-13 text-soft-light animate-underline-white" style="color:#895135;" href="about-us">
                                    {{ translate('About Us') }}
                                </a>
                            </li>
                        </ul>
